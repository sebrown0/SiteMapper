...
public interface TestElement {
	...
	TestElement setHeaderContainer(ZZZ_MenuItemContainer cont);
	TestElement setBodyContainer(ZZZ_MenuItemContainer cont);
	TestElement setFooterContainer(ZZZ_MenuItemContainer cont);
